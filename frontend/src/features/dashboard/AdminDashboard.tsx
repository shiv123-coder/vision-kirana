...
const growthData = [
  { name: 'Jan', applications: 400, disbursed: 240 },
  { name: 'Feb', applications: 300, disbursed: 139 },
  { name: 'Mar', applications: 500, disbursed: 480 },
  { name: 'Apr', applications: 780, disbursed: 390 },
  { name: 'May', applications: 890, disbursed: 680 },
  { name: 'Jun', applications: 1200, disbursed: 900 },
]
    ...
    <div className="container mx-auto px-4 py-8 space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">4,070</div>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">+₹50L this month</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
